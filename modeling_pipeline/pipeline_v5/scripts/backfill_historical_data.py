...
class HistoricalDataBackfill:
    ...
    def __init__(self, output_dir: str = 'data/historical'):
        ...
        (self.output_dir / 'standings').mkdir(exist_ok=True)
    ...
    def run_full_backfill(
        ...
        for fixture in tqdm(fixtures, desc="Extracting Data"):
            ...
            # Extract and save standings from participants.meta
            participants = fixture.get('participants', [])
            if participants:
                standings_data = []
                for participant in participants:
        ...
        logger.info(f"Extracted standings for {standings_count} fixtures")
