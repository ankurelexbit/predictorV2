...
class SportMonksConfig:
    ...
    # API Credentials - prefer environment variable, fallback to hardcoded
    ...
    # Caching
    CACHE_ENABLED = False  # Disabled - caching can cause slow lookups with large datasets
    CACHE_DIR = 'data/cache'
    CACHE_EXPIRY_DAYS = 30  # Historical data doesn't change

    # Leagues to track (Top 5 European leagues)
    LEAGUES = {
        'Premier League': 8,
        'La Liga': 564,
        'Bundesliga': 82,
